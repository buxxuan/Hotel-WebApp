	...
	<div class="row">
		...
		<div class="main-left-col">
			...
			<ul class="side-nav">
				...
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="collapse" data-target="#store-dropdown" href="listing.php"><i class="icon-time"></i> Schedule </a>
				</li>
				<li class="dropdown">
...
// 2. Do a query
$query  = "SELECT id, workday, workplace, date "; 
$query .= "FROM schedule";
